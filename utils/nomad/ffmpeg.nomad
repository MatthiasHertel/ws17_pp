...
#}
  ...
  group "cache" {
	...
	volumes = [
        	"/home/mhertel/projekt/ws17/ws17_pp/utils/nomad:/tmp",
     	]
	volume_driver = "flocker"
	# work_dir = "/home/mhertel/projekt/ws17/ws17_pp/utils/nomad:/tmp",
	
	#command = "ffmpeg -stats -i http://www.jell.yfish.us/media/jellyfish-20-mbps-hd-hevc-10bit.mkv -c:v libx265 -pix_fmt yuv420p10 -t 5 -f mp4 /tmp/test.mp4"

	command = "ffmpeg -stats -i jellyfish-20-mbps-hd-hevc-10bit.mkv test.mp4"

...
func NewJobSimpleAPI(spec *loads.Document) *JobSimpleAPI {
	return &JobSimpleAPI{
...
/*JobSimpleAPI A simple Rest-Api to submit Fibonacci Job through Stack. */
type JobSimpleAPI struct {
	spec            *loads.Document
...
func (o *JobSimpleAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *JobSimpleAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *JobSimpleAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *JobSimpleAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *JobSimpleAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *JobSimpleAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *JobSimpleAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the JobSimpleAPI
func (o *JobSimpleAPI) Validate() error {
...
func (o *JobSimpleAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *JobSimpleAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *JobSimpleAPI) Authorizer() runtime.Authorizer {
...
func (o *JobSimpleAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *JobSimpleAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *JobSimpleAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the job simple API
func (o *JobSimpleAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *JobSimpleAPI) initHandlerCache() {
...
func (o *JobSimpleAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
